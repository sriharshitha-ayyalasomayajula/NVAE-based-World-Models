...
if __name__ == '__main__':
    ...
    model.load_state_dict(torch.load("/home/pagadalam/Santhosh/Workspace/Fake_Assignments/world-models-nvae/carracing/world-models/logs/nvae/best_1.pth", map_location=device), strict=False)
